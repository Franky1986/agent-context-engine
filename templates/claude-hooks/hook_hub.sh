...
# Central hook adapter hub for claude.
...
# Explicit overrides remain authoritative. Otherwise derive the storage root
# from <storage>/.agent-context-engine/hooks/<runner>/hook_adapter.sh.
