    ...
    *,
    ...
    prompt = "\n".join(
        [
            ...
            "When the source content is not English, prefer an English canonical entity name when the translation is stable and unambiguous.",
            "Preserve the original source-language wording in aliases.",
            "Do not translate proper nouns, repository names, product names, commands, file paths, IDs, or titles that should remain verbatim.",
