...
def build_parser() -> argparse.ArgumentParser:
    ...
    global_wrapper_enable.add_argument("wrapper", choices=["codex-memory", "claude-memory", "agy-memory", "antigravity-memory", "gemini-memory", "opencode-memory"])
    ...
    global_wrapper_disable.add_argument("wrapper", choices=["codex-memory", "claude-memory", "agy-memory", "antigravity-memory", "gemini-memory", "opencode-memory"])
    ...
    install.add_argument("--memory-root", help="Persistent runtime storage root. Defaults to ~/.agent-context-engine/instances/default/memory")
    ...
    install.add_argument("--link-codex-memory", action="store_true")
    install.add_argument("--link-claude-memory", action="store_true")
    install.add_argument("--link-agy-memory", action="store_true")
    install.add_argument("--link-antigravity-memory", action="store_true")
    install.add_argument("--link-gemini-memory", action="store_true")
    install.add_argument("--link-opencode-memory", action="store_true")
    ...
    install.add_argument("--bootstrap-runtime", action="store_true", help="Create `.venv` and install backend dependencies into it during install")
