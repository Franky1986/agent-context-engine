...
- Traceable retrieval: `./scripts/agent-context-engine retrieve "<question or search terms>" --limit 10`
- Quick keyword search: `./scripts/agent-context-engine search "<search terms>" --limit 5`
- Load a session handover: `./scripts/agent-context-engine handover "<session|title|search terms>"`
- Recent sessions: `./scripts/agent-context-engine last --limit 10`
- Status: `./scripts/agent-context-engine doctor`
...
- After repository updates that can affect the monitor or API/UI code, restart
  the local monitor with `./scripts/agent-context-engine monitor --runner codex
...
- After repository updates that can affect scheduler defaults, dream runners,
  ...
  local LaunchAgent with `./scripts/agent-context-engine install-launchagent --load`.
...
- Treat `./scripts/agent-context-engine launchagent-status --verbose` and the monitor
